...
<div class="container my-5">
    <div class="row shadow bg-white rounded-4 overflow-hidden">
        ...
        <div class="col-lg-8 p-5">
            ...
            <form action="onlineapplication.php" method="POST">
                <div class="row g-3">
...
<?php
    ...
    $sql="insert into onlineapplication(name,dob,age,nic,gender,address,phone_number,email,reg_date,classofvehicle)
    values('$name','$dob','$age','$nic','$gender','$address','$phone_number','$email','$reg_date','$classofvehicle')";
